...
import { createUnit, deleteUnit, getUnit, listUnits, updateUnit, } from '../controllers/units.controller.js';
import { createDoctor, deleteDoctor, getDoctor, listDoctors, resetDoctorPassword, updateDoctor, } from '../controllers/doctors.controller.js';
...
import { getSettings, runAppointmentRemindersNow, updateSettings, } from '../controllers/settings.controller.js';
...
router.post('/settings/run-appointment-reminders', requireRole(['admin', 'superadmin']), runAppointmentRemindersNow);
...
router.post('/receptionists/:id/reset-password', requireRole(['admin', 'superadmin']), resetReceptionistPassword);
